...
parser.add_argument(
    "--lambda_u", default=50, type=float, help="weight for unsupervised loss"
)
parser.add_argument(
...
parser.add_argument(
    "--data_path", default="./data/tiny-imagenet-200", type=str, help="path to dataset"
)
...
loader = dataloader(
    ...
    noise_file="%s/clean_%.2f_%s.npz" % (args.data_path, args.ratio, args.noise_mode),
)
