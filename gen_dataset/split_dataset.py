...
def split(dataset_name, case, train_dataset=None, test_dataset=None, num_classes=100):
    ...
    if resplit:
        ...
        train_0_data_path_case = settings.get_dataset_path(dataset_name, case, "train_0_data", step=0)
        train_0_label_path_case = settings.get_dataset_path(dataset_name, case, "train_0_label", step=0)
