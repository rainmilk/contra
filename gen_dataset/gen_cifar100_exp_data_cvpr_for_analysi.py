...
def build_symmetric_mapping(classes):
    """构建对称标签映射"""
    num_classes = len(classes)
    symmetric_mapping = {i: (i + 1) % num_classes for i in range(num_classes)}
...
def create_cifar100_npy_files(
    ...
    if noise_type == "asymmetric":
        ...
        symmetric_mapping = build_symmetric_mapping(cifar100_classes)
    ...
    for true_label in D_noisy_true_labels:
        if noise_type == "asymmetric":
            ...
            new_label = symmetric_mapping[true_label]
