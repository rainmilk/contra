...
# 定义要运行的脚本
declare -a scripts=(
    "run_cifar100_mu_raw_cvpr.sh"
    "run_cifar100_mu_ga_cvpr.sh"
    "run_cifar100_mu_gal1_cvpr.sh"
    "run_cifar100_mu_ft_cvpr.sh"
    "run_cifar100_mu_ftl1_cvpr.sh"
    "run_cifar100_mu_fisher_new_cvpr.sh"
    "run_cifar100_mu_wfisher_cvpr.sh"
    "run_cifar100_mu_ftprune_cvpr.sh"
    "run_cifar100_mu_ftprunebi_cvpr.sh"
    "run_cifar100_mu_retrain_cvpr.sh"
    "run_cifar100_mu_retrainls_cvpr.sh"
    "run_cifar100_mu_retrainsam_cvpr.sh"
)
