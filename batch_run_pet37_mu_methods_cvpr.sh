...
declare -a scripts=(
    ...
    # "run_pet37_mu_ga_cvpr.sh" # 1
    # "run_pet37_mu_gal1_cvpr.sh" # 2
    # "run_pet37_mu_ft_cvpr.sh" # 1
    # "run_pet37_mu_ftl1_cvpr.sh" # 2
    # "run_pet37_mu_ftprune_cvpr.sh" # 1
    # "run_pet37_mu_ftprunebi_cvpr.sh" # 2
    # "run_pet37_mu_retrain_cvpr.sh" # 1
    # "run_pet37_mu_retrainls_cvpr.sh" # 2
    # "run_pet37_mu_retrainsam_cvpr.sh" # 3
