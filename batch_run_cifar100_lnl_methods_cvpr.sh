...
# 定义要运行的脚本
declare -a scripts=(
    "run_cifar100_lnl_coteaching_cvpr.sh"      # 1
    "run_cifar100_lnl_coteaching_plus_cvpr.sh" # 2
    # "run_cifar100_lnl_decoupling_cvpr.sh"      # 3
    # "run_cifar100_lnl_jocor_cvpr.sh" # 1
    # "run_cifar100_lnl_negativeLearning_cvpr.sh" # 2
    # "run_cifar100_lnl_pencil_cvpr.sh" # 3
