...
python ./baseline_code/lips-mu/main_mu_cvpr.py --model cifar-resnet18 --dataset cifar-10 --num_epochs 10 --batch_size 256 --uni_name retrain_sam --unlearn_lr 1e-3 --noise_ratio 0.5 --alpha 1e-3
