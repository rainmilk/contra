...
class Coteachingplus:
    def __init__(
        ...
        self.model1 = models.resnet18(pretrained=False, num_classes=config['num_classes']).to(self.device)
        self.model2 = models.resnet18(pretrained=False, num_classes=config['num_classes']).to(self.device)
