...
tasks=(
    ...
    # "run_pet37_rehearsal_sy_0.1.sh"
    # "run_pet37_rehearsal_sy_0.3.sh"
    # "run_pet37_rehearsal_sy_0.5.sh"
    ...
    # noise ratio: 0.5/0.3/0.1
    # method: raw/coteaching/contra
    # "run_pet37_rehearsal_asy_0.1.sh"
    # "run_pet37_rehearsal_asy_0.3.sh"
    # "run_pet37_rehearsal_asy_0.5.sh"
