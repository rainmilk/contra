...
python ./core_model/train_teacher.py --model cifar-resnet18 --dataset cifar-10 --num_epochs 150 --step 0 --learning_rate 0.02 --optimizer sgd --batch_size 256 --balanced
