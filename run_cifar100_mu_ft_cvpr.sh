...
python ./baseline_code/lips-mu/main_mu_cvpr.py --model cifar-wideresnet40 --dataset cifar-100 --num_epochs 10 --batch_size 256 --uni_name FT --unlearn_lr 1e-3 --noise_type asymmetric --noise_ratio 0.5 --alpha 1e-3
