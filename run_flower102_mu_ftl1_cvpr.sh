...
python ./baseline_code/lips-mu/main_mu_cvpr.py --model wideresnet50 --dataset flower-102 --num_epochs 10 --uni_name FT_l1 --learning_rate 1e-4 --optimizer adam --batch_size 64 --noise_type symmetric --noise_ratio 0.5 --alpha 1e-4
