...
parser.add_argument(
    "--lambda_u", default=30, type=float, help="weight for unsupervised loss"
)
parser.add_argument(
...
parser.add_argument(
    "--data_path", default="./data/cifar10", type=str, help="path to dataset"
)
...
stats_log = open(
    model_save_loc
    + "/%s_%.1f_%s" % (args.dataset, args.r, args.noise_mode)
    + "_stats.txt",
    "w",
)
test_log = open(
