...
python ./baseline_code/lips-mu/main_mu_cvpr.py --model wideresnet50 --dataset pet-37 --num_epochs 10 --batch_size 256 --uni_name FT_l1 --unlearn_lr 1e-3 --noise_type asymmetric --noise_ratio 0.5
