...
python ./core_model/train_teacher.py --model cifar-wideresnet40 --dataset cifar-100 --num_epochs 200 --step 0 --learning_rate 0.015 --optimizer adam --batch_size 256 --balanced --noise_type asymmetric --data_aug
