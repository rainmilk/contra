...
python ./baseline_code/colearn/main_disc_cvpr.py --model cifar-resnet18 --dataset cifar-10 --num_epochs 10 --batch_size 256 --uni_name DISC --learning_rate 1e-3 --noise_ratio 0.5
