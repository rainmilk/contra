...
python ./core_model/CRUL.py --model efficientnet_s --dataset cifar-100 --num_epochs 4 --repair_iter_num 10 --uni_name CRUL --learning_rate 5e-5 --optimizer adam --batch_size 256 --noise_type asymmetric --noise_ratio 0.9 --mixup_alpha 0.75
