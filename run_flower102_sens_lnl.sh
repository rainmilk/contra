...
python ./baseline_code/colearn/main_cvpr.py --model wideresnet50  --dataset flower-102 --num_epochs 10 --batch_size 64 --uni_name Coteachingplus --learning_rate 1e-4 --noise_type symmetric --noise_ratio 0.5
python ./baseline_code/colearn/main_cvpr.py --model wideresnet50  --dataset flower-102 --num_epochs 10 --batch_size 64 --uni_name Coteachingplus --learning_rate 1e-4 --noise_type symmetric --noise_ratio 0.75
