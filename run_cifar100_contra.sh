...
python ./core_model/core.py --model cifar-wideresnet40 --dataset cifar-100 --num_epochs 2 --step 1 --learning_rate 0.0002 --optimizer adam --batch_size 256 --balanced --noise_type asymmetric --uni_name contra
...
python ./core_model/core.py --model cifar-wideresnet40 --dataset cifar-100 --num_epochs 2 --step 2 --learning_rate 0.0002 --optimizer adam --batch_size 256 --balanced --noise_type asymmetric --uni_name contra
...
python ./core_model/core.py --model cifar-wideresnet40 --dataset cifar-100 --num_epochs 2 --step 3 --learning_rate 0.0002 --optimizer adam --batch_size 256 --balanced --noise_type asymmetric --uni_name contra
