...
declare -a scripts=(
    ...
    # "run_flower102_mu_ft_cvpr.sh" # 4
    # "run_flower102_mu_ftl1_cvpr.sh" # 5
    # "run_flower102_mu_fisher_new_cvpr.sh" # 6
    "run_flower102_mu_wfisher_cvpr.sh" # 7
    "run_flower102_mu_ftprune_cvpr.sh" # 8
    "run_flower102_mu_ftprunebi_cvpr.sh" # 9
    "run_flower102_mu_retrain_cvpr.sh" # 10
    "run_flower102_mu_retrainls_cvpr.sh" # 11
    "run_flower102_mu_retrainsam_cvpr.sh" # 12
)
