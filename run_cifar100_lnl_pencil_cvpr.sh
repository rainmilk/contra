...
python ./baseline_code/colearn/main_cvpr.py --model cifar-wideresnet40 --dataset cifar-100 --num_epochs 10 --batch_size 256 --uni_name PENCIL --learning_rate 1e-3  --noise_type asymmetric --noise_ratio 0.5
